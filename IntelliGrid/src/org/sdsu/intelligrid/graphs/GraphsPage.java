...
public class GraphsPage extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        res1 = new GraphViewSeries("Residential 1", new GraphViewSeriesStyle(Color.rgb(200,50,00),5), new GraphViewData[]{
         ...
         res2 = new GraphViewSeries("Residential 2", new GraphViewSeriesStyle(Color.BLUE,5),new GraphViewData[]{
         ...
         res3 = new GraphViewSeries("Residential 3", new GraphViewSeriesStyle(Color.GREEN,5),new GraphViewData[]{
         ...
         comm1 = new GraphViewSeries("Commercial 1", new GraphViewSeriesStyle(Color.MAGENTA,5),new GraphViewData[]{
         ...
         comm2 = new GraphViewSeries("Commercial 2", new GraphViewSeriesStyle(Color.CYAN,5),new GraphViewData[]{
         ...
         comm3 = new GraphViewSeries("Commercial 3", new GraphViewSeriesStyle(Color.YELLOW,5),new GraphViewData[]{
