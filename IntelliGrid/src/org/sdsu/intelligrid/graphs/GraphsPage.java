...
public class GraphsPage extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		res1 = new GraphViewSeries("Res 1 Forecast", new GraphViewSeriesStyle(
		...
		res2 = new GraphViewSeries("Res 2 Forecast", new GraphViewSeriesStyle(
		...
		res3 = new GraphViewSeries("Res 3 Forecast", new GraphViewSeriesStyle(
