...
public class MainUI {
    ...
    public void init2() {
        final List<Drawable> drawable = new ArrayList<>();
        drawable.add(SimInfo.Load1);
        Global.getRenderer().addDrawable(drawable);
    }
...
//    }
    ...
    public void postInit() {
        ...
        TextSprite Load1 = new TextSprite(
                "" + SimInfo.Load1 + " MW" + "\n" + "" + SimInfo.Load1r + " MVAR" + "\n" + "" + SimInfo.Load1a + " MVA",
                pixelsToCoords(1070, 1000), 20, Typeface.DEFAULT, 1000f, 0, 0,
                new Vector2f(1f, 1f), new Color(0, 0, 0));
        Global.getRenderer().addDrawable(Load1);

        TextSprite Load2 = new TextSprite(
                "" + SimInfo.Load2 + " MW" + "\n" + "" + SimInfo.Load2r + " MVAR" + "\n" + "" + SimInfo.Load2a + " MVA",
                pixelsToCoords(298, 665), 20, Typeface.DEFAULT, 1000f, 0, 0,
                new Vector2f(1f, 1f), new Color(0, 0, 0));
        Global.getRenderer().addDrawable(Load2);

        TextSprite Load3 = new TextSprite(
                "" + SimInfo.Load3 + " MW" + "\n" + "" + SimInfo.Load3r + " MVAR" + "\n" + "" + SimInfo.Load3a + " MVA",
                pixelsToCoords(630, 40), 20, Typeface.DEFAULT, 1000f, 0, 0,
                new Vector2f(1f, 1f), new Color(0, 0, 0));
        Global.getRenderer().addDrawable(Load3);

        TextSprite Load4 = new TextSprite(
                "" + SimInfo.Load4 + " MW" + "\n" + "" + SimInfo.Load4r + " MVAR" + "\n" + "" + SimInfo.Load4a + " MVA",
                pixelsToCoords(1700, 315), 20, Typeface.DEFAULT, 1000f, 0, 0,
                new Vector2f(1f, 1f), new Color(0, 0, 0));
        Global.getRenderer().addDrawable(Load4);

        TextSprite Load5 = new TextSprite(
                "" + SimInfo.Load5 + " MW" + "\n" + "" + SimInfo.Load5r + " MVAR" + "\n" + "" + SimInfo.Load5a + " MVA",
                pixelsToCoords(1900, 828), 20, Typeface.DEFAULT, 1000f, 0, 0,
                new Vector2f(1f, 1f), new Color(0, 0, 0));
        Global.getRenderer().addDrawable(Load5);

        TextSprite Load6 = new TextSprite(
                "" + SimInfo.Load6 + " MW" + "\n" + "" + SimInfo.Load6r + " MVAR" + "\n" + "" + SimInfo.Load6a + " MVA",
                pixelsToCoords(2000, 1170), 20, Typeface.DEFAULT, 1000f, 0, 0,
                new Vector2f(1f, 1f), new Color(0, 0, 0));
        Global.getRenderer().addDrawable(Load6);
    }
