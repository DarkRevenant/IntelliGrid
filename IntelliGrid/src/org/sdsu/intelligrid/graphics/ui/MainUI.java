...
public class MainUI {
	...
	public static Vector2f sizeToCoords(final float x, final float y) {
		return new Vector2f(2f * x
				/ (float) Global.getRenderer().getScreenHeight(), 2f * y
	...
	public void init() {
		...
		resources.add(R.drawable.carcheck);
		resources.add(R.drawable.carcheckoff);
		...
		resources.add(R.drawable.highcheck);
		resources.add(R.drawable.highcheckoff);
		...
		resources.add(R.drawable.lowcheck);
		resources.add(R.drawable.lowcheckoff);
		resources.add(R.drawable.mediumcheck);
		resources.add(R.drawable.mediumcheckoff);
		...
		resources.add(R.drawable.offcheck);
		resources.add(R.drawable.offcheckoff);
		...
		resources.add(R.drawable.sdgenight);
		resources.add(R.drawable.solarcheck);
		resources.add(R.drawable.solarcheckoff);
	...
	public static class ClickableObjects {
		...
		public static ClickableSprite pausedown;
	...
	public void postInit() {
		ClickableObjects.background = new ClickableSprite(new Vector2f(), 10,
				0f, new Vector2f(1.28f, 1.28f), new Color(255, 255, 255),
				R.drawable.background, sizeToCoords(-1280, -800), sizeToCoords(
						1280, 800), "background");
		...
		Objects.intelligrid = new Sprite(pixelsToCoords(195, 1555), 0, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.intelligrid);
		Global.getRenderer().addDrawable(Objects.intelligrid);

		Objects.sdge = new Sprite(pixelsToCoords(2415, 85), 0, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255), R.drawable.sdge);
		Global.getRenderer().addDrawable(Objects.sdge);

		Objects.sunny = new Sprite(pixelsToCoords(1800, 1551), 0, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.sunny);
		Global.getRenderer().addDrawable(Objects.sunny);

		Objects.partlycloudy = new Sprite(pixelsToCoords(1800, 1551), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.partlycloudy);
		Global.getRenderer().addDrawable(Objects.partlycloudy);

		Objects.cloudy = new Sprite(pixelsToCoords(1800, 1551), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.cloudy);
		Global.getRenderer().addDrawable(Objects.cloudy);

		ClickableObjects.faults = new ClickableSprite(
				pixelsToCoords(2485, 600), 0, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.faults, sizeToCoords(-64,
						-64), sizeToCoords(64, 64), "faults");
		Global.getRenderer().addDrawable(ClickableObjects.faults);
		addClickable(ClickableObjects.faults);

		ClickableObjects.faultspage = new ClickableSprite(pixelsToCoords(1280,
				800), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.faultspage, sizeToCoords(0, 0), sizeToCoords(0, 0),
				"faultspage");
		Global.getRenderer().addDrawable(ClickableObjects.faultspage);
		addClickable(ClickableObjects.faultspage);

		ClickableObjects.exitfaults = new ClickableSprite(pixelsToCoords(2280,
				1380), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.exit, sizeToCoords(-50, -50), sizeToCoords(50, 50),
				"exitfaults");
		Global.getRenderer().addDrawable(ClickableObjects.exitfaults);
		addClickable(ClickableObjects.exitfaults);

		ClickableObjects.graphs = new ClickableSprite(
				pixelsToCoords(2485, 460), 0, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.graphs, sizeToCoords(-64,
						-64), sizeToCoords(64, 64), "graphs");
		Global.getRenderer().addDrawable(ClickableObjects.graphs);
		addClickable(ClickableObjects.graphs);

		ClickableObjects.graphspage = new ClickableSprite(pixelsToCoords(1280,
				800), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.graphspage, sizeToCoords(0, 0), sizeToCoords(0, 0),
				"graphspage");
		Global.getRenderer().addDrawable(ClickableObjects.graphspage);
		addClickable(ClickableObjects.graphspage);

		ClickableObjects.exitgraphs = new ClickableSprite(pixelsToCoords(2280,
				1380), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.exit, sizeToCoords(-40, -40), sizeToCoords(40, 40),
				"exitgraphs");
		Global.getRenderer().addDrawable(ClickableObjects.exitgraphs);
		addClickable(ClickableObjects.exitgraphs);

		ClickableObjects.info = new ClickableSprite(pixelsToCoords(2485, 320),
				0, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.info, sizeToCoords(-50, -50), sizeToCoords(50, 50),
				"info");
		Global.getRenderer().addDrawable(ClickableObjects.info);
		addClickable(ClickableObjects.info);

		ClickableObjects.infopage = new ClickableSprite(pixelsToCoords(1280,
				800), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.infopage, sizeToCoords(-1050, -625), sizeToCoords(
						1050, 625), "infopage");
		Global.getRenderer().addDrawable(ClickableObjects.infopage);
		addClickable(ClickableObjects.infopage);

		ClickableObjects.exitinfo = new ClickableSprite(pixelsToCoords(2280,
				1380), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.exit, sizeToCoords(-40, -40), sizeToCoords(40, 40),
				"exitinfo");
		...
		ClickableObjects.play = new ClickableSprite(pixelsToCoords(2200, 1550),
				0, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.play, sizeToCoords(-32, -32), sizeToCoords(32, 32),
				"play");
		Global.getRenderer().addDrawable(ClickableObjects.play);
		addClickable(ClickableObjects.play);

		Objects.playdown = new Sprite(pixelsToCoords(2200, 1550), -1, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.playdown);
		Global.getRenderer().addDrawable(Objects.playdown);

		ClickableObjects.play2 = new ClickableSprite(
				pixelsToCoords(2290, 1550), 0, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.play2, sizeToCoords(-32,
						-32), sizeToCoords(32, 32), "play2");
		Global.getRenderer().addDrawable(ClickableObjects.play2);
		addClickable(ClickableObjects.play2);

		Objects.play2down = new Sprite(pixelsToCoords(2290, 1550), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.play2down);
		Global.getRenderer().addDrawable(Objects.play2down);

		ClickableObjects.play3 = new ClickableSprite(
				pixelsToCoords(2390, 1550), 0, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.play3, sizeToCoords(-32,
						-32), sizeToCoords(32, 32), "play3");
		Global.getRenderer().addDrawable(ClickableObjects.play3);
		addClickable(ClickableObjects.play3);

		Objects.play3down = new Sprite(pixelsToCoords(2390, 1550), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.play3down);
		Global.getRenderer().addDrawable(Objects.play3down);

		ClickableObjects.pause = new ClickableSprite(
				pixelsToCoords(2500, 1550), 0, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.pause, sizeToCoords(-32,
						-32), sizeToCoords(32, 32), "pause");
		Global.getRenderer().addDrawable(ClickableObjects.pause);
		addClickable(ClickableObjects.pause);

		ClickableObjects.pausedown = new ClickableSprite(pixelsToCoords(2500,
				1550), 0, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.pausedown, sizeToCoords(-32, -32), sizeToCoords(32,
						32), "pausedown");
		Global.getRenderer().addDrawable(ClickableObjects.pausedown);
		addClickable(ClickableObjects.pausedown);

		ClickableObjects.fault_a = new ClickableSprite(
				pixelsToCoords(565, 980), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.fault_a, sizeToCoords(-56,
						-60), sizeToCoords(56, 60), "faulta");
		Global.getRenderer().addDrawable(ClickableObjects.fault_a);
		addClickable(ClickableObjects.fault_a);

		ClickableObjects.fault_b = new ClickableSprite(
				pixelsToCoords(715, 980), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.fault_b, sizeToCoords(-56,
						-60), sizeToCoords(56, 60), "faultb");
		Global.getRenderer().addDrawable(ClickableObjects.fault_b);
		addClickable(ClickableObjects.fault_b);

		ClickableObjects.fault_c = new ClickableSprite(
				pixelsToCoords(1210, 980), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.fault_c, sizeToCoords(-56,
						-60), sizeToCoords(56, 60), "faultc");
		Global.getRenderer().addDrawable(ClickableObjects.fault_c);
		addClickable(ClickableObjects.fault_c);

		ClickableObjects.fault_d = new ClickableSprite(
				pixelsToCoords(1360, 980), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.fault_d, sizeToCoords(-56,
						-60), sizeToCoords(56, 60), "faultd");
		Global.getRenderer().addDrawable(ClickableObjects.fault_d);
		addClickable(ClickableObjects.fault_d);

		ClickableObjects.fault_e = new ClickableSprite(
				pixelsToCoords(1820, 980), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.fault_e, sizeToCoords(-56,
						-60), sizeToCoords(56, 60), "faulte");
		Global.getRenderer().addDrawable(ClickableObjects.fault_e);
		addClickable(ClickableObjects.fault_e);

		ClickableObjects.fault_f = new ClickableSprite(
				pixelsToCoords(1960, 980), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.fault_f, sizeToCoords(-56,
						-60), sizeToCoords(56, 60), "faultf");
		Global.getRenderer().addDrawable(ClickableObjects.fault_f);
		addClickable(ClickableObjects.fault_f);

		ClickableObjects.fault_h = new ClickableSprite(
				pixelsToCoords(1820, 690), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.fault_h, sizeToCoords(-56,
						-60), sizeToCoords(56, 60), "faulth");
		Global.getRenderer().addDrawable(ClickableObjects.fault_h);
		addClickable(ClickableObjects.fault_h);

		ClickableObjects.fault_i = new ClickableSprite(
				pixelsToCoords(1960, 690), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.fault_i, sizeToCoords(-56,
						-60), sizeToCoords(56, 60), "faulti");
		Global.getRenderer().addDrawable(ClickableObjects.fault_i);
		addClickable(ClickableObjects.fault_i);

		ClickableObjects.fault_j = new ClickableSprite(
				pixelsToCoords(1210, 690), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.fault_j, sizeToCoords(-56,
						-60), sizeToCoords(56, 60), "faultj");
		Global.getRenderer().addDrawable(ClickableObjects.fault_j);
		addClickable(ClickableObjects.fault_j);

		ClickableObjects.fault_k = new ClickableSprite(
				pixelsToCoords(1360, 690), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.fault_k, sizeToCoords(-56,
						-60), sizeToCoords(56, 60), "faultk");
		Global.getRenderer().addDrawable(ClickableObjects.fault_k);
		addClickable(ClickableObjects.fault_k);

		ClickableObjects.fault_l = new ClickableSprite(
				pixelsToCoords(565, 690), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.fault_l, sizeToCoords(-56,
						-60), sizeToCoords(56, 60), "faultl");
		Global.getRenderer().addDrawable(ClickableObjects.fault_l);
		addClickable(ClickableObjects.fault_l);

		ClickableObjects.fault_m = new ClickableSprite(
				pixelsToCoords(715, 690), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.fault_m, sizeToCoords(-56,
						-60), sizeToCoords(56, 60), "faultm");
		Global.getRenderer().addDrawable(ClickableObjects.fault_m);
		addClickable(ClickableObjects.fault_m);

		ClickableObjects.balloonfault = new ClickableSprite(pixelsToCoords(920,
				390), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.balloonfault, sizeToCoords(-58, -58), sizeToCoords(
						58, 58), "balloonfault");
		Global.getRenderer().addDrawable(ClickableObjects.balloonfault);
		addClickable(ClickableObjects.balloonfault);

		ClickableObjects.digfault = new ClickableSprite(pixelsToCoords(1590,
				390), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.digfault, sizeToCoords(-58, -58), sizeToCoords(58,
						58), "digfault");
		Global.getRenderer().addDrawable(ClickableObjects.digfault);
		addClickable(ClickableObjects.digfault);

		ClickableObjects.nofault = new ClickableSprite(
				pixelsToCoords(2170, 300), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.nofault, sizeToCoords(-76,
						-60), sizeToCoords(76, 60), "nofault");
		Global.getRenderer().addDrawable(ClickableObjects.nofault);
		addClickable(ClickableObjects.nofault);

		ClickableObjects.house1a = new ClickableSprite(
				pixelsToCoords(155, 120), 0, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.house1, sizeToCoords(-60,
						-62), sizeToCoords(60, 62), "house1a");
		Global.getRenderer().addDrawable(ClickableObjects.house1a);
		addClickable(ClickableObjects.house1a);

		ClickableObjects.house1asolar = new ClickableSprite(pixelsToCoords(155,
				120), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.house1solar, sizeToCoords(-60, -62), sizeToCoords(
						60, 62), "house1asolar");
		Global.getRenderer().addDrawable(ClickableObjects.house1asolar);
		addClickable(ClickableObjects.house1asolar);

		ClickableObjects.house1acar = new ClickableSprite(pixelsToCoords(155,
				120), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.house1car, sizeToCoords(-60, -62), sizeToCoords(60,
						62), "house1acar");
		Global.getRenderer().addDrawable(ClickableObjects.house1acar);
		addClickable(ClickableObjects.house1acar);

		ClickableObjects.house1aboth = new ClickableSprite(pixelsToCoords(155,
				120), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.house1both, sizeToCoords(-60, -62), sizeToCoords(60,
						62), "house1aboth");
		Global.getRenderer().addDrawable(ClickableObjects.house1aboth);
		addClickable(ClickableObjects.house1aboth);

		ClickableObjects.house1apopup = new ClickableSprite(pixelsToCoords(155,
				100), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.house1popup, sizeToCoords(-127, -84), sizeToCoords(
						172, 84), "house1apopup");
		Global.getRenderer().addDrawable(ClickableObjects.house1apopup);
		addClickable(ClickableObjects.house1apopup);

		ClickableObjects.house1asolarcheck = new ClickableSprite(
				pixelsToCoords(175, 125), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.solarcheck, sizeToCoords(-127, -23), sizeToCoords(127, 23), "house1asolarcheck");
		Global.getRenderer().addDrawable(ClickableObjects.house1asolarcheck);
		addClickable(ClickableObjects.house1asolarcheck);

		ClickableObjects.house1asolarcheckoff = new ClickableSprite(
				pixelsToCoords(175, 125), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.solarcheckoff,
				sizeToCoords(-127, -23), sizeToCoords(127, 23),
				"house1asolarcheckoff");
		Global.getRenderer().addDrawable(ClickableObjects.house1asolarcheckoff);
		addClickable(ClickableObjects.house1asolarcheckoff);

		ClickableObjects.house1acarcheck = new ClickableSprite(pixelsToCoords(
				175, 70), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.carcheck, sizeToCoords(-127, -23), sizeToCoords(127, 23), "house1acarcheck");
		Global.getRenderer().addDrawable(ClickableObjects.house1acarcheck);
		addClickable(ClickableObjects.house1acarcheck);

		ClickableObjects.house1acarcheckoff = new ClickableSprite(
				pixelsToCoords(175, 70), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.carcheckoff, sizeToCoords(-127, -23), sizeToCoords(127, 23), "house1acarcheckoff");
		Global.getRenderer().addDrawable(ClickableObjects.house1acarcheckoff);
		addClickable(ClickableObjects.house1acarcheckoff);

		ClickableObjects.house1b = new ClickableSprite(
				pixelsToCoords(375, 270), 0, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.house1, sizeToCoords(-60,
						-62), sizeToCoords(60, 62), "house1b");
		Global.getRenderer().addDrawable(ClickableObjects.house1b);
		addClickable(ClickableObjects.house1b);

		ClickableObjects.house1bsolar = new ClickableSprite(pixelsToCoords(375,
				270), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.house1solar, sizeToCoords(-60, -62), sizeToCoords(
						60, 62), "house1bsolar");
		Global.getRenderer().addDrawable(ClickableObjects.house1bsolar);
		addClickable(ClickableObjects.house1bsolar);

		ClickableObjects.house1bcar = new ClickableSprite(pixelsToCoords(375,
				270), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.house1car, sizeToCoords(-60, -62), sizeToCoords(60,
						62), "house1bcar");
		...
		ClickableObjects.house1bboth = new ClickableSprite(pixelsToCoords(375,
				270), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.house1both, sizeToCoords(-60, -62), sizeToCoords(60,
						62), "house1bboth");
		...
		ClickableObjects.house1bpopup = new ClickableSprite(pixelsToCoords(365,
				275), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.house1popup, sizeToCoords(-127, -84), sizeToCoords(
						172, 84), "house1bpopup");
		Global.getRenderer().addDrawable(ClickableObjects.house1bpopup);
		addClickable(ClickableObjects.house1bpopup);

		ClickableObjects.house1bsolarcheck = new ClickableSprite(
				pixelsToCoords(380, 300), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.solarcheck, sizeToCoords(-127, -23), sizeToCoords(127, 23), "house1bsolarcheck");
		Global.getRenderer().addDrawable(ClickableObjects.house1bsolarcheck);
		addClickable(ClickableObjects.house1bsolarcheck);

		ClickableObjects.house1bsolarcheckoff = new ClickableSprite(
				pixelsToCoords(380, 300), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.solarcheckoff,
				sizeToCoords(-127, -23), sizeToCoords(127, 23),
				"house1bsolarcheckoff");
		Global.getRenderer().addDrawable(ClickableObjects.house1bsolarcheckoff);
		addClickable(ClickableObjects.house1bsolarcheckoff);

		ClickableObjects.house1bcarcheck = new ClickableSprite(pixelsToCoords(
				380, 245), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255,
				255), R.drawable.carcheck, sizeToCoords(-127, -23), sizeToCoords(127, 23), "house1bcarcheck");
		Global.getRenderer().addDrawable(ClickableObjects.house1bcarcheck);
		addClickable(ClickableObjects.house1bcarcheck);

		ClickableObjects.house1bcarcheckoff = new ClickableSprite(
				pixelsToCoords(380, 245), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.carcheckoff, sizeToCoords(-127, -23), sizeToCoords(127, 23), "house1bcarcheckoff");
		Global.getRenderer().addDrawable(ClickableObjects.house1bcarcheckoff);
		addClickable(ClickableObjects.house1bcarcheckoff);

		ClickableObjects.house1c = new ClickableSprite(
				pixelsToCoords(615, 270), 0, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.house1, sizeToCoords(-60,
						-62), sizeToCoords(60, 62), "house1c");
		Global.getRenderer().addDrawable(ClickableObjects.house1c);
		addClickable(ClickableObjects.house1c);

		ClickableObjects.house1csolar = new ClickableSprite(pixelsToCoords(615,
				270), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.house1solar, sizeToCoords(-60, -62), sizeToCoords(
						60, 62), "house1csolar");
		...
		ClickableObjects.house1ccar = new ClickableSprite(pixelsToCoords(615,
				270), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.house1car, sizeToCoords(-60, -62), sizeToCoords(60,
						62), "house1ccar");
		...
		ClickableObjects.house1cboth = new ClickableSprite(pixelsToCoords(615,
				270), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.house1both, sizeToCoords(-60, -62), sizeToCoords(60,
						62), "house1cboth");
		...
		ClickableObjects.house1cpopup = new ClickableSprite(pixelsToCoords(625,
				275), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.house1popup, sizeToCoords(-127, -84), sizeToCoords(
						172, 84), "house1cpopup");
		...
		ClickableObjects.house1csolarcheck = new ClickableSprite(
				pixelsToCoords(640, 300), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.solarcheck, sizeToCoords(-127, -23), sizeToCoords(127, 23), "house1csolarcheck");
		Global.getRenderer().addDrawable(ClickableObjects.house1csolarcheck);
		addClickable(ClickableObjects.house1csolarcheck);

		ClickableObjects.house1csolarcheckoff = new ClickableSprite(
				pixelsToCoords(640, 300), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.solarcheckoff,
				sizeToCoords(-127, -23), sizeToCoords(127, 23),
				"house1csolarcheckoff");
		Global.getRenderer().addDrawable(ClickableObjects.house1csolarcheckoff);
		addClickable(ClickableObjects.house1csolarcheckoff);

		ClickableObjects.house1ccarcheck = new ClickableSprite(pixelsToCoords(
				640, 245), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255,
				255), R.drawable.carcheck, sizeToCoords(-127, -23), sizeToCoords(127, 23), "house1ccarcheck");
		Global.getRenderer().addDrawable(ClickableObjects.house1ccarcheck);
		addClickable(ClickableObjects.house1ccarcheck);

		ClickableObjects.house1ccarcheckoff = new ClickableSprite(
				pixelsToCoords(640, 245), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.carcheckoff, sizeToCoords(-127, -23), sizeToCoords(127, 23), "house1ccarcheckoff");
		Global.getRenderer().addDrawable(ClickableObjects.house1ccarcheckoff);
		addClickable(ClickableObjects.house1ccarcheckoff);

		ClickableObjects.house2a = new ClickableSprite(
				pixelsToCoords(135, 830), 0, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.house2, sizeToCoords(-69,
						-68), sizeToCoords(69, 68), "house2a");
		Global.getRenderer().addDrawable(ClickableObjects.house2a);
		addClickable(ClickableObjects.house2a);

		ClickableObjects.house2apopup = new ClickableSprite(pixelsToCoords(155,
				820), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.house2popup, sizeToCoords(-127, -84), sizeToCoords(
						172, 84), "house2apopup");
		Global.getRenderer().addDrawable(ClickableObjects.house2apopup);
		addClickable(ClickableObjects.house2apopup);

		ClickableObjects.house2asolarcheck = new ClickableSprite(
				pixelsToCoords(175, 820), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.solarcheck, sizeToCoords(-127, -23), sizeToCoords(127, 23), "house2asolarcheck");
		Global.getRenderer().addDrawable(ClickableObjects.house2asolarcheck);
		addClickable(ClickableObjects.house2asolarcheck);

		ClickableObjects.house2asolarcheckoff = new ClickableSprite(
				pixelsToCoords(175, 820), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.solarcheckoff,
				sizeToCoords(-127, -23), sizeToCoords(127, 23),
				"house2asolarcheckoff");
		Global.getRenderer().addDrawable(ClickableObjects.house2asolarcheckoff);
		addClickable(ClickableObjects.house2asolarcheckoff);

		ClickableObjects.house2asolar = new ClickableSprite(pixelsToCoords(140,
				825), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.house2solar, sizeToCoords(-69, -68), sizeToCoords(
						69, 68), "house2asolar");
		Global.getRenderer().addDrawable(ClickableObjects.house2asolar);
		addClickable(ClickableObjects.house2asolar);

		ClickableObjects.house2b = new ClickableSprite(
				pixelsToCoords(430, 830), 0, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.house2, sizeToCoords(-69,
						-68), sizeToCoords(69, 68), "house2b");
		Global.getRenderer().addDrawable(ClickableObjects.house2b);
		addClickable(ClickableObjects.house2b);

		ClickableObjects.house2bpopup = new ClickableSprite(pixelsToCoords(455,
				820), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.house2popup, sizeToCoords(-127, -84), sizeToCoords(
						172, 84), "house2bpopup");
		...
		ClickableObjects.house2bsolarcheck = new ClickableSprite(
				pixelsToCoords(475, 820), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.solarcheck, sizeToCoords(-127, -23), sizeToCoords(127, 23), "house2bsolarcheck");
		Global.getRenderer().addDrawable(ClickableObjects.house2bsolarcheck);
		addClickable(ClickableObjects.house2bsolarcheck);

		ClickableObjects.house2bsolarcheckoff = new ClickableSprite(
				pixelsToCoords(475, 820), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.solarcheckoff,
				sizeToCoords(-127, -23), sizeToCoords(127, 23),
				"house2bsolarcheckoff");
		Global.getRenderer().addDrawable(ClickableObjects.house2bsolarcheckoff);
		addClickable(ClickableObjects.house2bsolarcheckoff);

		ClickableObjects.house2bsolar = new ClickableSprite(pixelsToCoords(430,
				830), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.house2solar, sizeToCoords(-69, -68), sizeToCoords(
						69, 68), "house2bsolar");
		Global.getRenderer().addDrawable(ClickableObjects.house2bsolar);
		addClickable(ClickableObjects.house2bsolar);

		ClickableObjects.store = new ClickableSprite(pixelsToCoords(135, 490),
				0, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.store, sizeToCoords(-84, -64), sizeToCoords(84, 64),
				"store");
		Global.getRenderer().addDrawable(ClickableObjects.store);
		addClickable(ClickableObjects.store);

		ClickableObjects.business1a = new ClickableSprite(pixelsToCoords(1500,
				480), 0, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.business1, sizeToCoords(-101, -100), sizeToCoords(
						101, 100), "business1a");
		Global.getRenderer().addDrawable(ClickableObjects.business1a);
		addClickable(ClickableObjects.business1a);

		ClickableObjects.business1b = new ClickableSprite(pixelsToCoords(1920,
				1000), 0, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.business1, sizeToCoords(-101, -100), sizeToCoords(
						101, 100), "business1b");
		Global.getRenderer().addDrawable(ClickableObjects.business1b);
		addClickable(ClickableObjects.business1b);

		ClickableObjects.business2a = new ClickableSprite(pixelsToCoords(1900,
				580), 0, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.business2, sizeToCoords(-71, -118), sizeToCoords(71,
						118), "business2a");
		Global.getRenderer().addDrawable(ClickableObjects.business2a);
		addClickable(ClickableObjects.business2a);

		ClickableObjects.business2b = new ClickableSprite(pixelsToCoords(2145,
				775), 0, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.business2, sizeToCoords(-71, -118), sizeToCoords(71,
						118), "business2b");
		Global.getRenderer().addDrawable(ClickableObjects.business2b);
		addClickable(ClickableObjects.business2b);

		ClickableObjects.business2c = new ClickableSprite(pixelsToCoords(2300,
				900), 0, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.business2, sizeToCoords(-71, -118), sizeToCoords(71,
						118), "business2c");
		Global.getRenderer().addDrawable(ClickableObjects.business2c);
		addClickable(ClickableObjects.business2c);

		ClickableObjects.house3a = new ClickableSprite(
				pixelsToCoords(845, 1023), 0, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.house3, sizeToCoords(-94,
						-70), sizeToCoords(94, 70), "house3a");
		Global.getRenderer().addDrawable(ClickableObjects.house3a);
		addClickable(ClickableObjects.house3a);

		ClickableObjects.house3b = new ClickableSprite(pixelsToCoords(1061,
				1152), 0, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.house3, sizeToCoords(-94, -70),
				sizeToCoords(94, 70), "house3b");
		Global.getRenderer().addDrawable(ClickableObjects.house3b);
		addClickable(ClickableObjects.house3b);

		ClickableObjects.house3c = new ClickableSprite(
				pixelsToCoords(1060, 856), 0, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.house3, sizeToCoords(-94,
						-70), sizeToCoords(94, 70), "house3c");
		Global.getRenderer().addDrawable(ClickableObjects.house3c);
		addClickable(ClickableObjects.house3c);

		ClickableObjects.turbine = new ClickableSprite(
				pixelsToCoords(900, 1420), 0, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.turbine, sizeToCoords(-37,
						-49), sizeToCoords(37, 49), "turbine");
		Global.getRenderer().addDrawable(ClickableObjects.turbine);
		addClickable(ClickableObjects.turbine);

		ClickableObjects.turbine2 = new ClickableSprite(pixelsToCoords(1040,
				1435), 0, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.turbine, sizeToCoords(-37, -49),
				sizeToCoords(37, 49), "turbine2");
		Global.getRenderer().addDrawable(ClickableObjects.turbine2);
		addClickable(ClickableObjects.turbine2);

		ClickableObjects.turbinepopup = new ClickableSprite(pixelsToCoords(965,
				1385), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.turbinepopup, sizeToCoords(-127, -84), sizeToCoords(
						127, 84), "turbinepopup");
		Global.getRenderer().addDrawable(ClickableObjects.turbinepopup);
		addClickable(ClickableObjects.turbinepopup);

		ClickableObjects.turbinehighcheck = new ClickableSprite(pixelsToCoords(
				915, 1405), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255,
				255), R.drawable.highcheck, sizeToCoords(-77, -24),
				sizeToCoords(77, 24), "turbinehighcheck");
		Global.getRenderer().addDrawable(ClickableObjects.turbinehighcheck);
		addClickable(ClickableObjects.turbinehighcheck);

		ClickableObjects.turbinehighcheckoff = new ClickableSprite(
				pixelsToCoords(915, 1405), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.highcheckoff,
				sizeToCoords(-77, -24), sizeToCoords(77, 24),
				"turbinehighcheckoff");
		Global.getRenderer().addDrawable(ClickableObjects.turbinehighcheckoff);
		addClickable(ClickableObjects.turbinehighcheckoff);

		ClickableObjects.turbinemediumcheck = new ClickableSprite(
				pixelsToCoords(915, 1325), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.mediumcheck, sizeToCoords(
						-77, -23), sizeToCoords(77, 23), "turbinemediumcheck");
		Global.getRenderer().addDrawable(ClickableObjects.turbinemediumcheck);
		addClickable(ClickableObjects.turbinemediumcheck);

		ClickableObjects.turbinemediumcheckoff = new ClickableSprite(
				pixelsToCoords(915, 1325), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.mediumcheckoff,
				sizeToCoords(-77, -23), sizeToCoords(77, 23),
				"turbinemediumcheckoff");
		Global.getRenderer()
				.addDrawable(ClickableObjects.turbinemediumcheckoff);
		addClickable(ClickableObjects.turbinemediumcheckoff);

		ClickableObjects.turbinelowcheck = new ClickableSprite(pixelsToCoords(
				1055, 1325), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255,
				255), R.drawable.lowcheck, sizeToCoords(
                -56, -24), sizeToCoords(56, 24), "turbinelowcheck");
		Global.getRenderer().addDrawable(ClickableObjects.turbinelowcheck);
		addClickable(ClickableObjects.turbinelowcheck);

		ClickableObjects.turbinelowcheckoff = new ClickableSprite(
				pixelsToCoords(1055, 1325), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.lowcheckoff, sizeToCoords(
						-56, -24), sizeToCoords(56, 24), "turbinelowcheckoff");
		Global.getRenderer().addDrawable(ClickableObjects.turbinelowcheckoff);
		addClickable(ClickableObjects.turbinelowcheckoff);

		ClickableObjects.turbineoffcheck = new ClickableSprite(pixelsToCoords(
				1055, 1405), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255,
				255), R.drawable.offcheck, sizeToCoords(-57, -22),
                sizeToCoords(57, 22), "turbineoffcheck");
		Global.getRenderer().addDrawable(ClickableObjects.turbineoffcheck);
		addClickable(ClickableObjects.turbineoffcheck);

		ClickableObjects.turbineoffcheckoff = new ClickableSprite(
				pixelsToCoords(1055, 1405), 11, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.offcheckoff, sizeToCoords(-57, -22),
                sizeToCoords(57, 22), "turbineoffcheckoff");
		Global.getRenderer().addDrawable(ClickableObjects.turbineoffcheckoff);
		addClickable(ClickableObjects.turbineoffcheckoff);

		ClickableObjects.transformer1 = new ClickableSprite(pixelsToCoords(
				1200, 1000), 0, 0f, new Vector2f(1f, 1f), new Color(255, 255,
				255), R.drawable.transformer1, sizeToCoords(-30, -33),
				sizeToCoords(30, 33), "transformer1");
		Global.getRenderer().addDrawable(ClickableObjects.transformer1);
		addClickable(ClickableObjects.transformer1);

		ClickableObjects.transformer2 = new ClickableSprite(pixelsToCoords(520,
				640), 0, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.transformer1, sizeToCoords(-30, -33), sizeToCoords(
						30, 33), "transformer2");
		Global.getRenderer().addDrawable(ClickableObjects.transformer2);
		addClickable(ClickableObjects.transformer2);

		ClickableObjects.transformer3 = new ClickableSprite(pixelsToCoords(770,
				115), 0, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.transformer1, sizeToCoords(-30, -33), sizeToCoords(
						30, 33), "transformer3");
		Global.getRenderer().addDrawable(ClickableObjects.transformer3);
		addClickable(ClickableObjects.transformer3);

		ClickableObjects.transformer4 = new ClickableSprite(pixelsToCoords(
				1350, 335), 0, 0f, new Vector2f(1f, 1f), new Color(255, 255,
				255), R.drawable.transformer1, sizeToCoords(-30, -33),
				sizeToCoords(30, 33), "transformer4");
		Global.getRenderer().addDrawable(ClickableObjects.transformer4);
		addClickable(ClickableObjects.transformer4);

		ClickableObjects.transformer5 = new ClickableSprite(pixelsToCoords(
				1800, 800), 0, 0f, new Vector2f(1f, 1f), new Color(255, 255,
				255), R.drawable.transformer1, sizeToCoords(-30, -33),
				sizeToCoords(30, 33), "transformer5");
		Global.getRenderer().addDrawable(ClickableObjects.transformer5);
		addClickable(ClickableObjects.transformer5);

		ClickableObjects.transformer6 = new ClickableSprite(pixelsToCoords(
				1800, 1150), 0, 0f, new Vector2f(1f, 1f), new Color(255, 255,
				255), R.drawable.transformer1, sizeToCoords(-30, -33),
				sizeToCoords(30, 33), "transformer6");
		Global.getRenderer().addDrawable(ClickableObjects.transformer6);
		addClickable(ClickableObjects.transformer6);

		Objects.museum = new Sprite(pixelsToCoords(310, 1280), 0, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.museum);
		Global.getRenderer().addDrawable(Objects.museum);

		Objects.stadium = new Sprite(pixelsToCoords(2350, 1180), 0, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.stadium);
		Global.getRenderer().addDrawable(Objects.stadium);

		Objects.midway = new Sprite(pixelsToCoords(1722, 125), 0, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.midway);
		Global.getRenderer().addDrawable(Objects.midway);

		ClickableObjects.balloon = new ClickableSprite(
				pixelsToCoords(300, 680), 0, 0f, new Vector2f(1f, 1f),
				new Color(255, 255, 255), R.drawable.balloon, sizeToCoords(-20,
						-44), sizeToCoords(20, 44), "balloon");
		Global.getRenderer().addDrawable(ClickableObjects.balloon);
		addClickable(ClickableObjects.balloon);

		ClickableObjects.trackhoe = new ClickableSprite(pixelsToCoords(1305,
				550), 0, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.trackhoe, sizeToCoords(-32, -30), sizeToCoords(32,
						30), "trackhoe");
		Global.getRenderer().addDrawable(ClickableObjects.trackhoe);
		addClickable(ClickableObjects.trackhoe);

		Objects.battery1 = new Sprite(pixelsToCoords(1500, 1055), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.battery1);
		Global.getRenderer().addDrawable(Objects.battery1);

		Objects.battery2 = new Sprite(pixelsToCoords(1500, 1055), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.battery2);
		Global.getRenderer().addDrawable(Objects.battery2);

		Objects.battery3 = new Sprite(pixelsToCoords(1500, 1055), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.battery3);
		Global.getRenderer().addDrawable(Objects.battery3);

		Objects.solarpanel = new Sprite(pixelsToCoords(2275, 1415), 0, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.solarpanel);
		Global.getRenderer().addDrawable(Objects.solarpanel);

		Objects.substation = new Sprite(pixelsToCoords(1500, 1150), 0, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.substation);
		Global.getRenderer().addDrawable(Objects.substation);

		Objects.coal = new Sprite(pixelsToCoords(1530, 1427), 0, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255), R.drawable.coal);
		Global.getRenderer().addDrawable(Objects.coal);

		Objects.transformer1 = new Sprite(pixelsToCoords(1200, 1000), 0, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.transformer1);
		Global.getRenderer().addDrawable(Objects.transformer1);

		Objects.transformer2 = new Sprite(pixelsToCoords(520, 640), 0, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.transformer1);
		Global.getRenderer().addDrawable(Objects.transformer2);

		Objects.transformer3 = new Sprite(pixelsToCoords(770, 115), 0, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.transformer1);
		Global.getRenderer().addDrawable(Objects.transformer3);

		Objects.transformer4 = new Sprite(pixelsToCoords(1350, 335), 0, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.transformer1);
		Global.getRenderer().addDrawable(Objects.transformer4);

		Objects.transformer5 = new Sprite(pixelsToCoords(1800, 800), 0, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.transformer1);
		Global.getRenderer().addDrawable(Objects.transformer5);

		Objects.transformer6 = new Sprite(pixelsToCoords(1800, 1150), 0, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.transformer1);
		Global.getRenderer().addDrawable(Objects.transformer6);

		Objects.switch1 = new Sprite(pixelsToCoords(1300, 1000), 0, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switch1);
		Global.getRenderer().addDrawable(Objects.switch1);

		Objects.switch1top = new Sprite(pixelsToCoords(1300, 1000), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchtop);
		Global.getRenderer().addDrawable(Objects.switch1top);

		Objects.switch1middle = new Sprite(pixelsToCoords(1300, 1000), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchmiddle);
		Global.getRenderer().addDrawable(Objects.switch1middle);

		Objects.switch1bottom = new Sprite(pixelsToCoords(1300, 1000), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchbottom);
		Global.getRenderer().addDrawable(Objects.switch1bottom);

		Objects.switch1all = new Sprite(pixelsToCoords(1300, 1000), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchall);
		Global.getRenderer().addDrawable(Objects.switch1all);

		Objects.switch2 = new Sprite(pixelsToCoords(870, 450), 0, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switch1);
		Global.getRenderer().addDrawable(Objects.switch2);

		Objects.switch2top = new Sprite(pixelsToCoords(870, 450), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchtop);
		Global.getRenderer().addDrawable(Objects.switch2top);

		Objects.switch2middle = new Sprite(pixelsToCoords(870, 450), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchmiddle);
		Global.getRenderer().addDrawable(Objects.switch2middle);

		Objects.switch2bottom = new Sprite(pixelsToCoords(870, 450), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchbottom);
		Global.getRenderer().addDrawable(Objects.switch2bottom);

		Objects.switch2all = new Sprite(pixelsToCoords(870, 450), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchall);
		Global.getRenderer().addDrawable(Objects.switch2all);

		Objects.switch3 = new Sprite(pixelsToCoords(870, 115), 0, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switch1);
		Global.getRenderer().addDrawable(Objects.switch3);

		Objects.switch3top = new Sprite(pixelsToCoords(870, 115), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchtop);
		Global.getRenderer().addDrawable(Objects.switch3top);

		Objects.switch3middle = new Sprite(pixelsToCoords(870, 115), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchmiddle);
		Global.getRenderer().addDrawable(Objects.switch3middle);

		Objects.switch3bottom = new Sprite(pixelsToCoords(870, 115), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchbottom);
		Global.getRenderer().addDrawable(Objects.switch3bottom);

		Objects.switch3all = new Sprite(pixelsToCoords(870, 115), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchall);
		Global.getRenderer().addDrawable(Objects.switch3all);

		Objects.switch4 = new Sprite(pixelsToCoords(1250, 335), 0, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switch1);
		Global.getRenderer().addDrawable(Objects.switch4);

		Objects.switch4top = new Sprite(pixelsToCoords(1250, 335), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchtop);
		Global.getRenderer().addDrawable(Objects.switch4top);

		Objects.switch4middle = new Sprite(pixelsToCoords(1250, 335), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchmiddle);
		Global.getRenderer().addDrawable(Objects.switch4middle);

		Objects.switch4bottom = new Sprite(pixelsToCoords(1250, 335), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchbottom);
		Global.getRenderer().addDrawable(Objects.switch4bottom);

		Objects.switch4all = new Sprite(pixelsToCoords(1250, 335), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchall);
		Global.getRenderer().addDrawable(Objects.switch4all);

		Objects.switch5 = new Sprite(pixelsToCoords(1700, 800), 0, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switch1);
		Global.getRenderer().addDrawable(Objects.switch5);

		Objects.switch5top = new Sprite(pixelsToCoords(1700, 800), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchtop);
		Global.getRenderer().addDrawable(Objects.switch5top);

		Objects.switch5middle = new Sprite(pixelsToCoords(1700, 800), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchmiddle);
		Global.getRenderer().addDrawable(Objects.switch5middle);

		Objects.switch5bottom = new Sprite(pixelsToCoords(1700, 800), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchbottom);
		Global.getRenderer().addDrawable(Objects.switch5bottom);

		Objects.switch5all = new Sprite(pixelsToCoords(1700, 800), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchall);
		Global.getRenderer().addDrawable(Objects.switch5all);

		Objects.switch6 = new Sprite(pixelsToCoords(1700, 1043), 0, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switch1);
		Global.getRenderer().addDrawable(Objects.switch6);

		Objects.switch6top = new Sprite(pixelsToCoords(1700, 1043), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchtop);
		Global.getRenderer().addDrawable(Objects.switch6top);

		Objects.switch6middle = new Sprite(pixelsToCoords(1700, 1043), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchmiddle);
		Global.getRenderer().addDrawable(Objects.switch6middle);

		Objects.switch6bottom = new Sprite(pixelsToCoords(1700, 1043), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchbottom);
		Global.getRenderer().addDrawable(Objects.switch6bottom);

		Objects.switch6all = new Sprite(pixelsToCoords(1700, 1043), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.switchall);
		Global.getRenderer().addDrawable(Objects.switch6all);

		Objects.tie = new Sprite(pixelsToCoords(1050, 115), 0, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255), R.drawable.tie);
		Global.getRenderer().addDrawable(Objects.tie);

		Objects.tieopen = new Sprite(pixelsToCoords(1050, 115), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.tieopen);
		Global.getRenderer().addDrawable(Objects.tieopen);

		UIInfo.Load1 = new TextSprite("", pixelsToCoords(1080, 970), 25,
				Typeface.DEFAULT, 1000f, 11, 0, new Vector2f(1f, 1f),
				new Color(0, 0, 0));
		Global.getRenderer().addDrawable(UIInfo.Load1);

		ClickableObjects.load1stats = new ClickableSprite(pixelsToCoords(1000,
				1000), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.loadstats, sizeToCoords(-211, -140), sizeToCoords(
						211, 140), "load1stats");
		Global.getRenderer().addDrawable(ClickableObjects.load1stats);
		addClickable(ClickableObjects.load1stats);

		UIInfo.Load2 = new TextSprite("", pixelsToCoords(375, 645), 25,
				Typeface.DEFAULT, 1000f, 11, 0, new Vector2f(1f, 1f),
				new Color(0, 0, 0));
		Global.getRenderer().addDrawable(UIInfo.Load2);

		ClickableObjects.load2stats = new ClickableSprite(pixelsToCoords(295,
				675), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.loadstats, sizeToCoords(-211, -140), sizeToCoords(
						211, 140), "load2stats");
		Global.getRenderer().addDrawable(ClickableObjects.load2stats);
		addClickable(ClickableObjects.load2stats);

		UIInfo.Load3 = new TextSprite("", pixelsToCoords(480, 160), 25,
				Typeface.DEFAULT, 1000f, 11, 0, new Vector2f(1f, 1f),
				new Color(0, 0, 0));
		Global.getRenderer().addDrawable(UIInfo.Load3);

		ClickableObjects.load3stats = new ClickableSprite(pixelsToCoords(400,
				190), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.loadstats, sizeToCoords(-211, -140), sizeToCoords(
						211, 140), "load3stats");
		Global.getRenderer().addDrawable(ClickableObjects.load3stats);
		addClickable(ClickableObjects.load3stats);

		UIInfo.Load4 = new TextSprite("", pixelsToCoords(1610, 390), 25,
				Typeface.DEFAULT, 1000f, 11, 0, new Vector2f(1f, 1f),
				new Color(0, 0, 0));
		Global.getRenderer().addDrawable(UIInfo.Load4);

		ClickableObjects.load4stats = new ClickableSprite(pixelsToCoords(1530,
				420), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.loadstats, sizeToCoords(-211, -140), sizeToCoords(
						211, 140), "load4stats");
		Global.getRenderer().addDrawable(ClickableObjects.load4stats);
		addClickable(ClickableObjects.load4stats);

		UIInfo.Load5 = new TextSprite("", pixelsToCoords(2060, 690), 25,
				Typeface.DEFAULT, 1000f, 11, 0, new Vector2f(1f, 1f),
				new Color(0, 0, 0));
		Global.getRenderer().addDrawable(UIInfo.Load5);

		ClickableObjects.load5stats = new ClickableSprite(pixelsToCoords(1980,
				720), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.loadstats, sizeToCoords(-211, -140), sizeToCoords(
						211, 140), "load5stats");
		Global.getRenderer().addDrawable(ClickableObjects.load5stats);
		addClickable(ClickableObjects.load5stats);

		UIInfo.Load6 = new TextSprite("", pixelsToCoords(2090, 1110), 25,
				Typeface.DEFAULT, 1000f, 11, 0, new Vector2f(1f, 1f),
				new Color(0, 0, 0));
		Global.getRenderer().addDrawable(UIInfo.Load6);

		ClickableObjects.load6stats = new ClickableSprite(pixelsToCoords(2010,
				1140), 11, 0f, new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.loadstats, sizeToCoords(-211, -140), sizeToCoords(
						211, 140), "load6stats");
		Global.getRenderer().addDrawable(ClickableObjects.load6stats);
		addClickable(ClickableObjects.load6stats);

		UIInfo.trA = new TextSprite("", pixelsToCoords(1365, 1200), 30,
				Typeface.DEFAULT, 1000f, 0, 0, new Vector2f(1f, 1f), new Color(
						0, 0, 0));
		Global.getRenderer().addDrawable(UIInfo.trA);

		Objects.label_a = new Sprite(pixelsToCoords(1310, 1150), 2, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.label_a);
		Global.getRenderer().addDrawable(Objects.label_a);

		Objects.xouta = new Sprite(pixelsToCoords(1310, 1150), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255), R.drawable.xout);
		Global.getRenderer().addDrawable(Objects.xouta);

		UIInfo.trB = new TextSprite("", pixelsToCoords(1230, 945), 30,
				Typeface.DEFAULT, 1000f, 0, 0, new Vector2f(1f, 1f), new Color(
						0, 0, 0));
		Global.getRenderer().addDrawable(UIInfo.trB);

		Objects.label_b = new Sprite(pixelsToCoords(1063, 1005), 2, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.label_b);
		Global.getRenderer().addDrawable(Objects.label_b);

		Objects.xoutb = new Sprite(pixelsToCoords(1063, 1005), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255), R.drawable.xout);
		Global.getRenderer().addDrawable(Objects.xoutb);

		UIInfo.trC = new TextSprite("", pixelsToCoords(970, 690), 30,
				Typeface.DEFAULT, 1000f, 0, 0, new Vector2f(1f, 1f), new Color(
						0, 0, 0));
		Global.getRenderer().addDrawable(UIInfo.trC);

		Objects.label_c = new Sprite(pixelsToCoords(885, 747), 2, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.label_c);
		Global.getRenderer().addDrawable(Objects.label_c);

		Objects.xoutc = new Sprite(pixelsToCoords(885, 747), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255), R.drawable.xout);
		Global.getRenderer().addDrawable(Objects.xoutc);

		UIInfo.trD = new TextSprite("", pixelsToCoords(620, 640), 30,
				Typeface.DEFAULT, 1000f, 0, 0, new Vector2f(1f, 1f), new Color(
						0, 0, 0));
		Global.getRenderer().addDrawable(UIInfo.trD);

		Objects.label_d = new Sprite(pixelsToCoords(430, 645), 2, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.label_d);
		Global.getRenderer().addDrawable(Objects.label_d);

		Objects.xoutd = new Sprite(pixelsToCoords(430, 645), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255), R.drawable.xout);
		Global.getRenderer().addDrawable(Objects.xoutd);

		UIInfo.trE = new TextSprite("", pixelsToCoords(965, 290), 30,
				Typeface.DEFAULT, 1000f, 0, 0, new Vector2f(1f, 1f), new Color(
						0, 0, 0));
		Global.getRenderer().addDrawable(UIInfo.trE);

		Objects.label_e = new Sprite(pixelsToCoords(870, 290), 2, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.label_e);
		Global.getRenderer().addDrawable(Objects.label_e);

		Objects.xoute = new Sprite(pixelsToCoords(870, 290), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255), R.drawable.xout);
		Global.getRenderer().addDrawable(Objects.xoute);

		UIInfo.trF = new TextSprite("", pixelsToCoords(800, 60), 30,
				Typeface.DEFAULT, 1000f, 0, 0, new Vector2f(1f, 1f), new Color(
						0, 0, 0));
		Global.getRenderer().addDrawable(UIInfo.trF);

		Objects.label_f = new Sprite(pixelsToCoords(470, 120), 2, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.label_f);
		Global.getRenderer().addDrawable(Objects.label_f);

		Objects.xoutf = new Sprite(pixelsToCoords(470, 120), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255), R.drawable.xout);
		Global.getRenderer().addDrawable(Objects.xoutf);

		UIInfo.trG = new TextSprite("", pixelsToCoords(1145, 110), 30,
				Typeface.DEFAULT, 1000f, 0, 0, new Vector2f(1f, 1f), new Color(
						0, 0, 0));
		Global.getRenderer().addDrawable(UIInfo.trG);

		UIInfo.trH = new TextSprite("", pixelsToCoords(1370, 280), 30,
				Typeface.DEFAULT, 1000f, 0, 0, new Vector2f(1f, 1f), new Color(
						0, 0, 0));
		Global.getRenderer().addDrawable(UIInfo.trH);

		Objects.label_h = new Sprite(pixelsToCoords(1653, 336), 2, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.label_h);
		Global.getRenderer().addDrawable(Objects.label_h);

		Objects.xouth = new Sprite(pixelsToCoords(1653, 336), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255), R.drawable.xout);
		Global.getRenderer().addDrawable(Objects.xouth);

		UIInfo.trI = new TextSprite("", pixelsToCoords(1500, 650), 30,
				Typeface.DEFAULT, 1000f, 0, 0, new Vector2f(1f, 1f), new Color(
						0, 0, 0));
		Global.getRenderer().addDrawable(UIInfo.trI);

		Objects.label_i = new Sprite(pixelsToCoords(1685, 630), 2, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.label_i);
		Global.getRenderer().addDrawable(Objects.label_i);

		Objects.xouti = new Sprite(pixelsToCoords(1685, 630), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255), R.drawable.xout);
		Global.getRenderer().addDrawable(Objects.xouti);

		UIInfo.trJ = new TextSprite("", pixelsToCoords(1820, 745), 30,
				Typeface.DEFAULT, 1000f, 0, 0, new Vector2f(1f, 1f), new Color(
						0, 0, 0));
		Global.getRenderer().addDrawable(UIInfo.trJ);

		Objects.label_j = new Sprite(pixelsToCoords(1898, 800), 2, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.label_j);
		Global.getRenderer().addDrawable(Objects.label_j);

		Objects.xoutj = new Sprite(pixelsToCoords(1898, 800), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255), R.drawable.xout);
		Global.getRenderer().addDrawable(Objects.xoutj);

		UIInfo.trK = new TextSprite("", pixelsToCoords(1630, 910), 30,
				Typeface.DEFAULT, 1000f, 0, 0, new Vector2f(1f, 1f), new Color(
						0, 0, 0));
		Global.getRenderer().addDrawable(UIInfo.trK);

		Objects.label_k = new Sprite(pixelsToCoords(1700, 920), 2, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.label_k);
		Global.getRenderer().addDrawable(Objects.label_k);

		Objects.xoutk = new Sprite(pixelsToCoords(1700, 920), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255), R.drawable.xout);
		Global.getRenderer().addDrawable(Objects.xoutk);

		UIInfo.trL = new TextSprite("", pixelsToCoords(1820, 1095), 30,
				Typeface.DEFAULT, 1000f, 0, 0, new Vector2f(1f, 1f), new Color(
						0, 0, 0));
		Global.getRenderer().addDrawable(UIInfo.trL);

		Objects.label_l = new Sprite(pixelsToCoords(2050, 1150), 2, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.label_l);
		Global.getRenderer().addDrawable(Objects.label_l);

		Objects.xoutl = new Sprite(pixelsToCoords(2050, 1150), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255), R.drawable.xout);
		Global.getRenderer().addDrawable(Objects.xoutl);

		UIInfo.trM = new TextSprite("", pixelsToCoords(1680, 1200), 30,
				Typeface.DEFAULT, 1000f, 0, 0, new Vector2f(1f, 1f), new Color(
						0, 0, 0));
		Global.getRenderer().addDrawable(UIInfo.trM);

		Objects.label_m = new Sprite(pixelsToCoords(1685, 1150), 2, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255),
				R.drawable.label_m);
		Global.getRenderer().addDrawable(Objects.label_m);

		Objects.xoutm = new Sprite(pixelsToCoords(1685, 1150), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255), R.drawable.xout);
		Global.getRenderer().addDrawable(Objects.xoutm);

		Objects.xoutballoon = new Sprite(pixelsToCoords(305, 647), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255), R.drawable.xout);
		Global.getRenderer().addDrawable(Objects.xoutballoon);

		Objects.xoutdig = new Sprite(pixelsToCoords(1250, 535), 11, 0f,
				new Vector2f(1f, 1f), new Color(255, 255, 255), R.drawable.xout);
		Global.getRenderer().addDrawable(Objects.xoutdig);

		UIInfo.WindTurbines = new TextSprite("", pixelsToCoords(1250, 1370),
				20, Typeface.DEFAULT, 1000f, 0, 0, new Vector2f(1f, 1f),
				new Color(0, 0, 0, 0));
		Global.getRenderer().addDrawable(UIInfo.WindTurbines);

		UIInfo.PowPlant = new TextSprite("", pixelsToCoords(1930, 1370), 20,
				Typeface.DEFAULT, 1000f, 0, 0, new Vector2f(1f, 1f), new Color(
						0, 0, 0, 0));
		...
		UIInfo.currentTime = new TextSprite("", pixelsToCoords(2000, 1550), 40,
				Typeface.DEFAULT, 1000f, 0, 0, new Vector2f(1f, 1f), new Color(
						0, 0, 0));
	...
	/**
	 * Called when the simulation ends an automatically-detected fault
	 * (time-out).
	 */
	...
	public void advance(final float amount) {
		...
		if (step == 2) {
			...
			step = 0;
			Global.getGlobalSimulation().data.timeScale = 0.0;
		}
		...
		// Fault State
		final String fault = Global.getGlobalSimulation().faultManager
				.getCurrentFault();
		...
		// Night Time Mode
		if ((Simulation.SimInfo.currentTime > 19.5 || Simulation.SimInfo.currentTime < 6.00)
				&& !night) {
			night = true;
			ClickableObjects.background.setResourceOverTime(
					R.drawable.backgroundnight, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.graphs.setResourceOverTime(R.drawable.graphsnight,
					DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.info.setResourceOverTime(R.drawable.infonight,
					DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.business1a.setResourceOverTime(
					R.drawable.business1night, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.business1b.setResourceOverTime(
					R.drawable.business1night, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.business2a.setResourceOverTime(
					R.drawable.business2night, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.business2b.setResourceOverTime(
					R.drawable.business2night, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.business2c.setResourceOverTime(
					R.drawable.business2night, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house1a.setResourceOverTime(
					R.drawable.house1night, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house1asolar.setResourceOverTime(
					R.drawable.house1solarnight, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house1acar.setResourceOverTime(
					R.drawable.house1carnight, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house1aboth.setResourceOverTime(
					R.drawable.house1bothnight, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house1b.setResourceOverTime(
					R.drawable.house1night, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house1bsolar.setResourceOverTime(
					R.drawable.house1solarnight, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house1bcar.setResourceOverTime(
					R.drawable.house1carnight, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house1bboth.setResourceOverTime(
					R.drawable.house1bothnight, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house1c.setResourceOverTime(
					R.drawable.house1night, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house1csolar.setResourceOverTime(
					R.drawable.house1solarnight, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house1ccar.setResourceOverTime(
					R.drawable.house1carnight, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house1cboth.setResourceOverTime(
					R.drawable.house1bothnight, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house2a.setResourceOverTime(
					R.drawable.house2night, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house2asolar.setResourceOverTime(
					R.drawable.house2solarnight, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house2b.setResourceOverTime(
					R.drawable.house2night, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house2bsolar.setResourceOverTime(
					R.drawable.house2solarnight, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.store.setResourceOverTime(R.drawable.storenight,
					DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house3a.setResourceOverTime(
					R.drawable.house3night, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house3b.setResourceOverTime(
					R.drawable.house3night, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house3c.setResourceOverTime(
					R.drawable.house3night, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.turbine.setResourceOverTime(
					R.drawable.turbinenight, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.turbine2.setResourceOverTime(
					R.drawable.turbinenight, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.transformer1.setResourceOverTime(
					R.drawable.transformer1night, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.transformer2.setResourceOverTime(
					R.drawable.transformer1night, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.transformer3.setResourceOverTime(
					R.drawable.transformer1night, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.transformer4.setResourceOverTime(
					R.drawable.transformer1night, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.transformer5.setResourceOverTime(
					R.drawable.transformer1night, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.transformer6.setResourceOverTime(
					R.drawable.transformer1night, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.balloon.setResourceOverTime(
					R.drawable.balloonnight, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.trackhoe.setResourceOverTime(
					R.drawable.trackhoenight, DAY_NIGHT_TRANSITION_TIME);
			Objects.sunny.setResourceOverTime(R.drawable.night,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.partlycloudy.setResourceOverTime(R.drawable.night,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.cloudy.setResourceOverTime(R.drawable.night,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.coal.setResourceOverTime(R.drawable.coalnight,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.battery1.setResourceOverTime(R.drawable.battery1night,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.battery2.setResourceOverTime(R.drawable.battery2night,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.battery3.setResourceOverTime(R.drawable.battery3night,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.midway.setResourceOverTime(R.drawable.midwaynight,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.museum.setResourceOverTime(R.drawable.museumnight,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.solarpanel.setResourceOverTime(R.drawable.solarpanelnight,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.stadium.setResourceOverTime(R.drawable.stadiumnight,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.substation.setResourceOverTime(R.drawable.substationnight,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch1top.setResourceOverTime(R.drawable.switchtopnight,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch1middle.setResourceOverTime(
					R.drawable.switchmiddlenight, DAY_NIGHT_TRANSITION_TIME);
			Objects.switch1bottom.setResourceOverTime(
					R.drawable.switchbottomnight, DAY_NIGHT_TRANSITION_TIME);
			Objects.switch2top.setResourceOverTime(R.drawable.switchtopnight,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch2middle.setResourceOverTime(
					R.drawable.switchmiddlenight, DAY_NIGHT_TRANSITION_TIME);
			Objects.switch2bottom.setResourceOverTime(
					R.drawable.switchbottomnight, DAY_NIGHT_TRANSITION_TIME);
			Objects.switch3top.setResourceOverTime(R.drawable.switchtopnight,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch3middle.setResourceOverTime(
					R.drawable.switchmiddlenight, DAY_NIGHT_TRANSITION_TIME);
			Objects.switch3bottom.setResourceOverTime(
					R.drawable.switchbottomnight, DAY_NIGHT_TRANSITION_TIME);
			Objects.switch4top.setResourceOverTime(R.drawable.switchtopnight,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch4middle.setResourceOverTime(
					R.drawable.switchmiddlenight, DAY_NIGHT_TRANSITION_TIME);
			Objects.switch4bottom.setResourceOverTime(
					R.drawable.switchbottomnight, DAY_NIGHT_TRANSITION_TIME);
			Objects.switch5top.setResourceOverTime(R.drawable.switchtopnight,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch5middle.setResourceOverTime(
					R.drawable.switchmiddlenight, DAY_NIGHT_TRANSITION_TIME);
			Objects.switch5bottom.setResourceOverTime(
					R.drawable.switchbottomnight, DAY_NIGHT_TRANSITION_TIME);
			Objects.switch6top.setResourceOverTime(R.drawable.switchtopnight,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch6middle.setResourceOverTime(
					R.drawable.switchmiddlenight, DAY_NIGHT_TRANSITION_TIME);
			Objects.switch6bottom.setResourceOverTime(
					R.drawable.switchbottomnight, DAY_NIGHT_TRANSITION_TIME);
			Objects.switch1.setResourceOverTime(R.drawable.switch1night,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch2.setResourceOverTime(R.drawable.switch1night,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch3.setResourceOverTime(R.drawable.switch1night,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch4.setResourceOverTime(R.drawable.switch1night,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch5.setResourceOverTime(R.drawable.switch1night,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch6.setResourceOverTime(R.drawable.switch1night,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.tie.setResourceOverTime(R.drawable.tienight,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.tieopen.setResourceOverTime(R.drawable.tieopennight,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.sdge.setResourceOverTime(R.drawable.sdgenight,
					DAY_NIGHT_TRANSITION_TIME);
		...
		if ((Simulation.SimInfo.currentTime <= 19.5 && Simulation.SimInfo.currentTime >= 6.00)
			...
			night = false;
			ClickableObjects.background.setResourceOverTime(
					R.drawable.background, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.graphs.setResourceOverTime(R.drawable.graphs,
					DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.info.setResourceOverTime(R.drawable.info,
					DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.business1a.setResourceOverTime(
					R.drawable.business1, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.business1b.setResourceOverTime(
					R.drawable.business1, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.business2a.setResourceOverTime(
					R.drawable.business2, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.business2b.setResourceOverTime(
					R.drawable.business2, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.business2c.setResourceOverTime(
					R.drawable.business2, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house1a.setResourceOverTime(R.drawable.house1,
					DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house1asolar.setResourceOverTime(
					R.drawable.house1solar, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house1acar.setResourceOverTime(
					R.drawable.house1car, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house1aboth.setResourceOverTime(
					R.drawable.house1both, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house1b.setResourceOverTime(R.drawable.house1,
					DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house1bsolar.setResourceOverTime(
					R.drawable.house1solar, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house1bcar.setResourceOverTime(
			...
			ClickableObjects.house1bboth.setResourceOverTime(
					R.drawable.house1both, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house1c.setResourceOverTime(R.drawable.house1,
					DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house1csolar.setResourceOverTime(
					R.drawable.house1solar, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house1ccar.setResourceOverTime(
			...
			ClickableObjects.house1cboth.setResourceOverTime(
					R.drawable.house1both, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house2a.setResourceOverTime(R.drawable.house2,
					DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house2asolar.setResourceOverTime(
					R.drawable.house2solar, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house2b.setResourceOverTime(R.drawable.house2,
					DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house2bsolar.setResourceOverTime(
					R.drawable.house2solar, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.store.setResourceOverTime(R.drawable.store,
					DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house3a.setResourceOverTime(R.drawable.house3,
					DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house3b.setResourceOverTime(R.drawable.house3,
					DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.house3c.setResourceOverTime(R.drawable.house3,
					DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.turbine.setResourceOverTime(R.drawable.turbine,
					DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.turbine2.setResourceOverTime(R.drawable.turbine,
					DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.transformer1.setResourceOverTime(
					R.drawable.transformer1, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.transformer2.setResourceOverTime(
					R.drawable.transformer1, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.transformer3.setResourceOverTime(
					R.drawable.transformer1, DAY_NIGHT_TRANSITION_TIME);
			...
			ClickableObjects.transformer6.setResourceOverTime(
					R.drawable.transformer1, DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.balloon.setResourceOverTime(R.drawable.balloon,
					DAY_NIGHT_TRANSITION_TIME);
			ClickableObjects.trackhoe.setResourceOverTime(R.drawable.trackhoe,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.sunny.setResourceOverTime(R.drawable.sunny,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.partlycloudy.setResourceOverTime(R.drawable.partlycloudy,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.cloudy.setResourceOverTime(R.drawable.cloudy,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.coal.setResourceOverTime(R.drawable.coal,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.battery1.setResourceOverTime(R.drawable.battery1,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.battery2.setResourceOverTime(R.drawable.battery2,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.battery3.setResourceOverTime(R.drawable.battery3,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.midway.setResourceOverTime(R.drawable.midway,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.midway.setResourceOverTime(R.drawable.midway,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.museum.setResourceOverTime(R.drawable.museum,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.solarpanel.setResourceOverTime(R.drawable.solarpanel,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.stadium.setResourceOverTime(R.drawable.stadium,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.substation.setResourceOverTime(R.drawable.substation,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch1top.setResourceOverTime(R.drawable.switchtop,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch1middle.setResourceOverTime(R.drawable.switchmiddle,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch1bottom.setResourceOverTime(R.drawable.switchbottom,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch2top.setResourceOverTime(R.drawable.switchtop,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch2middle.setResourceOverTime(R.drawable.switchmiddle,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch2bottom.setResourceOverTime(R.drawable.switchbottom,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch3top.setResourceOverTime(R.drawable.switchtop,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch3middle.setResourceOverTime(R.drawable.switchmiddle,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch3bottom.setResourceOverTime(R.drawable.switchbottom,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch4top.setResourceOverTime(R.drawable.switchtop,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch4middle.setResourceOverTime(R.drawable.switchmiddle,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch4bottom.setResourceOverTime(R.drawable.switchbottom,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch5top.setResourceOverTime(R.drawable.switchtop,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch5middle.setResourceOverTime(R.drawable.switchmiddle,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch5bottom.setResourceOverTime(R.drawable.switchbottom,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch6top.setResourceOverTime(R.drawable.switchtop,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch6middle.setResourceOverTime(R.drawable.switchmiddle,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch6bottom.setResourceOverTime(R.drawable.switchbottom,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch1.setResourceOverTime(R.drawable.switch1,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch2.setResourceOverTime(R.drawable.switch1,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch3.setResourceOverTime(R.drawable.switch1,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch4.setResourceOverTime(R.drawable.switch1,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch5.setResourceOverTime(R.drawable.switch1,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.switch6.setResourceOverTime(R.drawable.switch1,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.tie.setResourceOverTime(R.drawable.tie,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.tieopen.setResourceOverTime(R.drawable.tieopen,
					DAY_NIGHT_TRANSITION_TIME);
			Objects.sdge.setResourceOverTime(R.drawable.sdge,
					DAY_NIGHT_TRANSITION_TIME);
		...
		if (textUpdateTimer <= 0f) {
			if (Math.random() < textUpdateChance)
				UIInfo.Load1.setText(
						"\t\t\t\t\t\t\t\t\t\t\t\t"
								...
								+ ""
								+ String.format("%.2f",
										Simulation.SimInfo.Load1)
								+ " MW"
								+ "\n"
								+ "Reactive Power: \t\t\t"
								+ String.format("%.2f",
										Simulation.SimInfo.Load1r)
								+ " MVAR"
								+ "\n"
								+ "Apparent Power: \t\t"
								+ String.format("%.2f",
										Simulation.SimInfo.Load1a) + " MVA",
						UIInfo.Load1.getFontSize(), UIInfo.Load1.getFont(),
						UIInfo.Load1.getMaxLineWidth());

			if (Math.random() < textUpdateChance)
				UIInfo.Load2.setText(
						"\t\t\t\t\t\t\t\t\t\t\t\t"
								+ "Residential 2"
								+ "\n"
								+ "\n"
								...
								+ ""
								+ String.format("%.2f",
										Simulation.SimInfo.Load2)
								+ " MW"
								+ "\n"
								+ "Reactive Power: \t\t\t"
								+ String.format("%.2f",
										Simulation.SimInfo.Load2r)
								+ " MVAR"
								+ "\n"
								+ "Apparent Power: \t\t"
								+ String.format("%.2f",
										Simulation.SimInfo.Load2a) + " MVA",
						UIInfo.Load2.getFontSize(), UIInfo.Load2.getFont(),
						UIInfo.Load2.getMaxLineWidth());

			if (Math.random() < textUpdateChance)
				UIInfo.Load3.setText(
						"\t\t\t\t\t\t\t\t\t\t\t\t"
								+ "Residential 3"
								+ "\n"
								+ "\n"
								...
								+ ""
								+ String.format("%.2f",
										Simulation.SimInfo.Load3)
								+ " MW"
								+ "\n"
								+ "Reactive Power: \t\t\t"
								+ String.format("%.2f",
										Simulation.SimInfo.Load3r)
								+ " MVAR"
								+ "\n"
								+ "Apparent Power: \t\t"
								+ String.format("%.2f",
										Simulation.SimInfo.Load3a) + " MVA",
						UIInfo.Load3.getFontSize(), UIInfo.Load3.getFont(),
						UIInfo.Load3.getMaxLineWidth());

			if (Math.random() < textUpdateChance)
				UIInfo.Load4.setText(
						"\t\t\t\t\t\t\t\t\t\t\t\t"
								+ "Commercial 3"
								+ "\n"
								+ "\n"
								...
								+ ""
								+ String.format("%.2f",
										Simulation.SimInfo.Load4)
								+ " MW"
								+ "\n"
								+ "Reactive Power: \t\t\t"
								+ String.format("%.2f",
										Simulation.SimInfo.Load4r)
								+ " MVAR"
								+ "\n"
								+ "Apparent Power: \t\t"
								+ String.format("%.2f",
										Simulation.SimInfo.Load4a) + " MVA",
						UIInfo.Load4.getFontSize(), UIInfo.Load4.getFont(),
						UIInfo.Load4.getMaxLineWidth());

			if (Math.random() < textUpdateChance)
				UIInfo.Load5.setText(
						"\t\t\t\t\t\t\t\t\t\t\t\t"
								+ "Commercial 2"
								+ "\n"
								+ "\n"
								...
								+ ""
								+ String.format("%.2f",
										Simulation.SimInfo.Load5)
								+ " MW"
								+ "\n"
								+ "Reactive Power: \t\t\t"
								+ String.format("%.2f",
										Simulation.SimInfo.Load5r)
								+ " MVAR"
								+ "\n"
								+ "Apparent Power: \t\t\t"
								+ String.format("%.2f",
										Simulation.SimInfo.Load5a) + " MVA",
						UIInfo.Load5.getFontSize(), UIInfo.Load5.getFont(),
						UIInfo.Load5.getMaxLineWidth());

			if (Math.random() < textUpdateChance)
				UIInfo.Load6.setText(
						"\t\t\t\t\t\t\t\t\t\t\t\t"
								+ "Commercial 1"
								+ "\n"
								+ "\n"
								...
								+ "Reactive Power: \t\t\t"
								+ String.format("%.2f",
										Simulation.SimInfo.Load6r)
								+ " MVAR"
								+ "\n"
								+ "Apparent Power: \t\t"
								+ String.format("%.2f",
										Simulation.SimInfo.Load6a) + " MVA",
			...
			if (Math.random() < textUpdateChance)
				UIInfo.trM.setText(
						""
								+ String.format("%.2f",
										Simulation.SimInfo.trM * 100) + " %",
						UIInfo.trM.getFontSize(), UIInfo.trM.getFont(),
						UIInfo.trM.getMaxLineWidth());

			if (Math.random() < textUpdateChance)
				UIInfo.WindTurbines.setText(
						""
								+ String.format("%.2f",
										Simulation.SimInfo.WindTurbines)
								+ " MW", UIInfo.WindTurbines.getFontSize(),
						UIInfo.WindTurbines.getFont(), UIInfo.WindTurbines
								.getMaxLineWidth());
				...
				UIInfo.PowPlant
						.setText(
								""
										+ String.format(
												"%.2f",
												Simulation.SimInfo.PowPlant)
										+ " MW", UIInfo.PowPlant.getFontSize(),
								UIInfo.PowPlant.getFont(), UIInfo.PowPlant
										.getMaxLineWidth());

			// if (Math.random() < textUpdateChance)
			// UIInfo.transTotal.setText("" + String.format("%.2f",
			// Simulation.SimInfo.transTotal) + " MVA",
			// UIInfo.transTotal.getFontSize(), UIInfo.transTotal.getFont(),
			// UIInfo.transTotal.getMaxLineWidth());

			// if (Math.random() < textUpdateChance)
			// UIInfo.SDGE.setText("" + String.format("%.2f",
			// Simulation.SimInfo.SDGE) + " MW",
			...
			UIInfo.currentTime.setText(
					"" + hours + ":" + String.format("%02d", minutes) + " "
							+ amPM, UIInfo.currentTime.getFontSize(),
					UIInfo.currentTime.getFont(),
		...
		if (lightPacketTimer <= 0f) {
			...
			MainNetworkHandler.constructAndSendPacket(
					MainNetworkHandler.PacketTypes.LIGHT_ANIMATION, null);
		...
		if (graphUpdateTimer <= 0f) {
			...
			Global.getMainActivity().runOnUiThread(new Runnable() {
				@Override
				public void run() {
					View decorView = Global.getMainActivity().getWindow()
							.getDecorView();
