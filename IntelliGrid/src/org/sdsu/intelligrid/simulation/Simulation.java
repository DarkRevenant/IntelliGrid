...
public class Simulation {
	...
	public static class SimulationData {
		// Solar Panels
		public static double[] Solar = { 0.0000, 0.0000, 0.0000, 0.0000,
				0.0000, 0.0000, 0.0000, 0.3360, 1.0000, 1.2000, 1.4000, 1.6000,
				1.6000, 1.6000, 1.6000, 1.6000, 1.4000, 1.2000, 1.0000, 0.3360,
				0.0000, 0.0000, 0.0000, 0.0000 };

		// Power Plant
		public static double[] PowerPlant = { 0.0000, 0.0000, 0.0000, 0.0000,
				0.0000, 0.0000, 0.0000, 0.7396, 2.2013, 2.6415, 3.0818, 3.5220,
				3.5220, 3.5220, 3.5220, 3.5220, 3.0818, 2.6415, 2.2013, 0.7396,
				0.0000, 0.0000, 0.0000, 0.0000 };

		// Wind Farm
		public static double[] WindFarm = { 2.6880, 2.7112, 2.8134, 2.8632,
				2.9523, 2.9200, 2.8032, 2.1200, 1.4320, 1.2560, 1.0952, 1.1117,
				1.1030, 1.2077, 1.6400, 2.0077, 2.3328, 2.8560, 3.0160, 3.1360,
				3.0720, 3.0080, 2.9440, 2.8800 };

		// Battery Charge
		public static double[] Battery = { -0.1830, -0.3170, -0.4000, -0.3500,
				-0.3000, -0.2500, -0.0100, 0.8000, 0.8000, 0.2000, -0.0100,
				-0.3000, -0.1000, -0.2000, -0.6000, -0.4000, -0.2000, 0.8000,
				1.0000, -0.0100, -0.0100, -0.0100, -0.0100, -0.0100 };

		// Battery Charge Level
		public static double[] BatteryLevel = { 1, 1, 2, 2, 2, 3, 3, 3, 2, 1,
				1, 1, 2, 2, 2, 3, 3, 2, 1, 1, 1, 1, 1 };

		// Need battery storage level array

		// REAL POWER
		public static double[] res1 = { 1.0220, 0.9084, 0.8903, 0.9690, 0.9779,
				0.9701, 1.2303, 1.5096, 1.6967, 1.4974, 1.1932, 1.0940, 1.0671,
				1.0776, 1.1014, 1.1951, 1.3356, 2.1166, 2.4681, 2.4938, 2.2363,
				1.7361, 1.4971, 1.0412 };
		public static double[] res2 = { 1.3226, 1.2350, 1.1521, 1.1714, 1.2655,
				1.3395, 1.4891, 1.9143, 1.9993, 1.7613, 1.5656, 1.4158, 1.3810,
				1.3946, 1.3281, 1.6177, 1.9143, 2.6586, 2.9305, 2.9394, 2.6627,
				2.2468, 1.8003, 1.2249 };
		public static double[] res3 = { 1.2023, 1.0688, 1.0474, 1.0650, 1.1505,
				1.1413, 1.3538, 1.6673, 1.9119, 1.7617, 1.4706, 1.2871, 1.2554,
				1.2678, 1.2958, 1.4706, 1.5713, 2.4169, 2.7848, 2.7113, 2.4206,
				2.0425, 1.7613, 1.2249 };
		public static double[] comm1 = { 1.5227, 1.5248, 1.5136, 1.5146,
				1.5248, 1.5654, 1.7575, 2.4650, 2.7852, 2.8249, 2.8198, 2.7878,
				2.8511, 2.8675, 2.9152, 2.9430, 2.8889, 2.7878, 2.4650, 1.8094,
				1.7585, 1.7575, 1.6162, 1.5654 };
		public static double[] comm2 = { 1.4231, 1.4250, 1.4146, 1.4155,
				1.4250, 1.4630, 1.6426, 2.3038, 2.6030, 2.6401, 2.6353, 2.6054,
				2.6999, 2.6800, 2.6524, 2.8011, 2.6999, 2.6054, 2.3038, 1.6910,
				1.6435, 1.6426, 1.5105, 1.4630 };
		public static double[] comm3 = { 1.5939, 1.5837, 1.5843, 1.5126,
				1.5960, 1.6426, 1.7946, 2.6073, 2.9154, 2.9112, 2.9515, 2.9564,
				3.0239, 2.9849, 2.9992, 3.0676, 3.0239, 2.9129, 2.8571, 1.8939,
				1.7110, 1.7091, 1.6918, 1.6386 };

		// REACTIVE POWER
		public static double[] res1r = { 0.6129583499, 0.5448626293,
				0.5339653767, 0.54292534, 0.5865143503, 0.5818648559,
				0.6901593305, 0.8499857018, 0.9747180765, 0.8981273421,
				0.749730978, 0.6561599024, 0.6400319686, 0.646328159,
				0.6606156679, 0.749730978, 0.8010691457, 1.232183831,
				1.450303239, 1.38225595, 1.234053315, 1.041293025,
				0.8979336131, 0.6244852216 };
		public static double[] res2r = { 0.6742541849, 0.6296190383,
				0.5873619144, 0.597217874, 0.6451657854, 0.6828944954,
				0.7591752635, 0.9759095094, 1.019256359, 0.8979336131,
				0.7981632117, 0.7217758927, 0.7040351655, 0.7109609749,
				0.6770826274, 0.8247040758, 0.9759095094, 1.355402214,
				1.595333563, 1.608434482, 1.357458647, 1.145422327,
				0.917790829, 0.6869337437 };

		public static double[] res3r = { 0.5210145975, 0.4631332349,
				0.4538705702, 0.4940087839, 0.4985371978, 0.4945851275,
				0.6271974267, 0.7695881938, 0.8649996942, 0.7634082408,
				0.6083088555, 0.5577359171, 0.5440271733, 0.5493789351,
				0.5615233177, 0.6092775002, 0.6809087739, 1.079070167,
				1.258269432, 1.271346135, 1.140094782, 0.8850990712,
				0.7632435712, 0.5308124383 };
		public static double[] comm1r = { 1.451029722, 1.452967012, 1.44231192,
				1.443280565, 1.452967012, 1.491712799, 1.674786642,
				2.348963335, 2.654086408, 2.69186355, 2.687020327, 2.656508019,
				2.752888165, 2.732546626, 2.704455931, 2.856048822,
				2.752888165, 2.656508019, 2.348963335, 1.72418752, 1.675755287,
				1.674786642, 1.540145032, 1.491712799 };
		public static double[] comm2r = { 1.625153289, 1.614730672,
				1.615389351, 1.542324483, 1.627323053, 1.674786642, 1.82976979,
				2.658445309, 2.972576777, 2.855080178, 3.009462766,
				2.913586316, 3.083234744, 3.043481567, 2.830864061,
				3.127753654, 3.083234744, 2.852658566, 2.913198858,
				1.931090023, 1.744529059, 1.742591769, 1.724962436, 1.670718334 };
		public static double[] comm3r = { 2.54269227, 2.436141356, 2.329590442,
				2.271471761, 2.223039528, 2.436625678, 2.644399961,
				2.857501789, 3.070603618, 3.283705446, 3.598514965,
				3.705065879, 3.811616794, 4.024718622, 4.23782045, 4.446079055,
				4.660633851, 4.658212239, 4.660149528, 4.339528141,
				3.811616794, 3.283705446, 2.964052704, 2.54269227 };

		// Electric Vehicles
		public double EV = 0.4; // electric vehicle load (per vehicle)

		// Weather for Solar Panels
		public static double[] weather = { 1, .8, .6, .4, .2 }; // Sunny to
																// cloudy
		public double w = 0;
		...
		// Time Scale
		public double timeScale = 288.0; // ex. timeScale 100 = 1 second of
											// application time is 100 seconds
											// of simulation
	...
	public static class MutableValue {
		...
		public void changeOverTime(final double toValue, final double time,
				final boolean simulationTimeInterpolation) {
		...
		protected void advance(final double amount, final double hours) {
			...
			if (time >= interpolateEndTime) {
				...
				value = interpolateStart * (1.0 - progress) + interpolateEnd
						* progress;
			}
		}
	}
		...
		private void advance(final double hours) {
			if (balloonFaultTimeOut > 0.0) {
				...
				if (balloonFaultTimeOut <= 0.0) {
					...
					MainNetworkHandler.constructAndSendPacket(
							PacketTypes.BALLOON_DETECT_RESET, false);
				}
			}
			if (digFaultTimeOut > 0.0) {
				...
				if (digFaultTimeOut <= 0.0) {
					...
					MainNetworkHandler.constructAndSendPacket(
							PacketTypes.DIG_DETECT_RESET, false);
				}
			}
		...
		private void refreshFaultState() {
			if (balloonFaultTimeOut > 0.0 && digFaultTimeOut <= 0.0) {
				...
				if (SimInfo.trM > LOAD_THRESHOLD
						&& (genericFault.equals("A")
								|| genericFault.equals("C") || genericFault
									.equals("E"))) {
					currentFault = "ACE";
					automaticFaultTimeOut = AUTOMATIC_FAULT_TIME;
					automaticFault = currentFault;
					automaticFaultOn = true;
						...
						&& (genericFault.equals("M")
								|| genericFault.equals("K") || genericFault
									.equals("I"))) {
					currentFault = "MKI";
					automaticFaultTimeOut = AUTOMATIC_FAULT_TIME;
					automaticFault = currentFault;
				...
				// Check to see if a feeder is overloading
				if (SimInfo.trM > LOAD_THRESHOLD) {
					final double neededPower = (SimInfo.trM - LOAD_THRESHOLD)
							+ DESIRED_BUFFER;
					if (SimInfo.Load6 >= neededPower
							&& SimInfo.Load6 >= SimInfo.Load4
							&& SimInfo.Load6 >= SimInfo.Load5) {
						// Less important
						currentFault = "L";
					} else if (SimInfo.Load5 >= neededPower
							&& SimInfo.Load5 >= SimInfo.Load4
							&& SimInfo.Load5 >= SimInfo.Load6) {
						currentFault = "J";
					} else if (SimInfo.Load4 >= neededPower
							&& SimInfo.Load4 >= SimInfo.Load5
							&& SimInfo.Load4 >= SimInfo.Load6) {
						// More important
						currentFault = "H";
					} else {
						// The line is well and truly screwed
						// Can't open a tie because that will just strain the
						// other line to the breaking point
						// Just have to shut down the commercial line; power
						// outage!
						currentFault = "MKI";
					}
					automaticFaultTimeOut = AUTOMATIC_FAULT_TIME;
					automaticFault = currentFault;
					automaticFaultOn = true;
					Global.getMainUI().reportAutomaticFaultStarted(
							automaticFault);
				} else if (SimInfo.trA > LOAD_THRESHOLD) {
					final double neededPower = (SimInfo.trA - LOAD_THRESHOLD)
							+ DESIRED_BUFFER;
					if (SimInfo.Load3 >= neededPower
							&& SimInfo.Load3 >= SimInfo.Load1
							&& SimInfo.Load3 >= SimInfo.Load2) {
						// Less important
						currentFault = "F";
					} else if (SimInfo.Load2 >= neededPower
							&& SimInfo.Load2 >= SimInfo.Load1
							&& SimInfo.Load2 >= SimInfo.Load3) {
						currentFault = "D";
					} else if (SimInfo.Load1 >= neededPower
							&& SimInfo.Load1 >= SimInfo.Load2
							&& SimInfo.Load1 >= SimInfo.Load3) {
						// More important
						currentFault = "B";
					} else {
						// The line is well and truly screwed
						// Can't open a tie because that will just strain the
						// other line to the breaking point
						// Just have to shut down the residential line; power
						// outage!
						currentFault = "ACE";
					}
					automaticFaultTimeOut = AUTOMATIC_FAULT_TIME;
					...
					// In this scenario, it's impossible for any particular node
					// to draw more power than the two feeders from the
					// substation
					// Therefore, if neither A or M are at the threshold, no
					// automatic fault can occur
					currentFault = "";
					if (automaticFaultOn) {
						automaticFaultOn = false;
						Global.getMainUI().reportAutomaticFaultEnded(
								automaticFault);
					}
				}
			} else {
				// Simplify matters by periodically testing the waters to see
				// what happens
				if (automaticFaultTimeOut <= 0.0) {
					currentFault = "";
				}
	...
	public void advance(final float amount) {
		...
		if (data.time >= 6.0 && data.time - hours < 6.0) {
			MainNetworkHandler.constructAndSendPacket(PacketTypes.TIME_OF_DAY,
					false);
		...
		if (Global.getNetworkInterface().isConnected()
				&& !hasConnectionBeenMade) {
			hasConnectionBeenMade = true;
			if (data.time >= 6.0 && data.time < 19.5) {
				MainNetworkHandler.constructAndSendPacket(
						PacketTypes.TIME_OF_DAY, false);
			} else {
				MainNetworkHandler.constructAndSendPacket(
						PacketTypes.TIME_OF_DAY, true);
			}
			if (data.load1WasOn) {
				MainNetworkHandler.constructAndSendPacket(
						PacketTypes.POWER_OUTAGE,
						new MainNetworkHandler.OutageData(1, true));
			} else {
				MainNetworkHandler.constructAndSendPacket(
						PacketTypes.POWER_OUTAGE,
						new MainNetworkHandler.OutageData(1, false));
			}
			if (data.load2WasOn) {
				MainNetworkHandler.constructAndSendPacket(
						PacketTypes.POWER_OUTAGE,
						new MainNetworkHandler.OutageData(2, true));
			} else {
				MainNetworkHandler.constructAndSendPacket(
						PacketTypes.POWER_OUTAGE,
						new MainNetworkHandler.OutageData(2, false));
			}
			if (data.load3WasOn) {
				MainNetworkHandler.constructAndSendPacket(
						PacketTypes.POWER_OUTAGE,
						new MainNetworkHandler.OutageData(3, true));
			} else {
				MainNetworkHandler.constructAndSendPacket(
						PacketTypes.POWER_OUTAGE,
						new MainNetworkHandler.OutageData(3, false));
			}
			if (data.load4WasOn) {
				MainNetworkHandler.constructAndSendPacket(
						PacketTypes.POWER_OUTAGE,
						new MainNetworkHandler.OutageData(4, true));
			} else {
				MainNetworkHandler.constructAndSendPacket(
						PacketTypes.POWER_OUTAGE,
						new MainNetworkHandler.OutageData(4, false));
			}
			if (data.load5WasOn) {
				MainNetworkHandler.constructAndSendPacket(
						PacketTypes.POWER_OUTAGE,
						new MainNetworkHandler.OutageData(5, true));
			} else {
				MainNetworkHandler.constructAndSendPacket(
						PacketTypes.POWER_OUTAGE,
						new MainNetworkHandler.OutageData(5, false));
			}
			if (data.load6WasOn) {
				MainNetworkHandler.constructAndSendPacket(
						PacketTypes.POWER_OUTAGE,
						new MainNetworkHandler.OutageData(6, true));
			} else {
				MainNetworkHandler.constructAndSendPacket(
						PacketTypes.POWER_OUTAGE,
						new MainNetworkHandler.OutageData(6, false));
			}
			MainNetworkHandler.constructAndSendPacket(
					PacketTypes.BATTERY_STORAGE_LEVEL,
					(int) linear(SimulationData.BatteryLevel, time));
			if (data.windGenerationLevel.get() < 0.1) {
				MainNetworkHandler.constructAndSendPacket(
						PacketTypes.WIND_GENERATION_LEVEL, 0);
			} else if (data.windGenerationLevel.get() < 0.4) {
				MainNetworkHandler.constructAndSendPacket(
						PacketTypes.WIND_GENERATION_LEVEL, 1);
			} else if (data.windGenerationLevel.get() < 0.7) {
				MainNetworkHandler.constructAndSendPacket(
		...
		} else if (!Global.getNetworkInterface().isConnected()
				&& hasConnectionBeenMade) {
		...
		double Load2 = linear(SimulationData.res2, time)
				- ((data.solarPanelM1.get() + data.solarPanelM2.get()) * (linear(
						SimulationData.Solar, time)
						* data.solarCoefficientM
						* data.middleSolarLevel.get() * linear(
							SimulationData.weather, data.w)));
		double Load3 = linear(SimulationData.res3, time)
				+ ((data.electricVehicleL1.get() + data.electricVehicleL2.get() + data.electricVehicleL3
						.get()) * data.EV)
				- ((data.solarPanelL1.get() + data.solarPanelL2.get() + data.solarPanelL3
						.get()) * (linear(SimulationData.Solar, time)
						* data.solarCoefficientL * data.lowerSolarLevel.get() * linear(
							SimulationData.weather, data.w)));
		...
		double Load1a = Math.sqrt((Load1 * Load1)
				+ (linear(SimulationData.res1r, time) * linear(
						SimulationData.res1r, time)));
		double Load2a = Math.sqrt((Load2 * Load2)
				+ (linear(SimulationData.res2r, time) * linear(
						SimulationData.res2r, time)));
		double Load3a = Math.sqrt((Load3 * Load3)
				+ (linear(SimulationData.res3r, time) * linear(
						SimulationData.res3r, time)));
		double Load4a = Math.sqrt((Load4 * Load4)
				+ (linear(SimulationData.comm2r, time) * linear(
						SimulationData.comm2r, time)));
		double Load5a = Math.sqrt((Load5 * Load5)
				+ (linear(SimulationData.comm1r, time) * linear(
						SimulationData.comm1r, time)));
		double Load6a = Math.sqrt((Load6 * Load6)
				+ (linear(SimulationData.comm3r, time) * linear(
						SimulationData.comm3r, time)));
		...
		if (Load1a <= 0 && data.load1WasOn) {
			...
			MainNetworkHandler.constructAndSendPacket(PacketTypes.POWER_OUTAGE,
					new MainNetworkHandler.OutageData(1, false));
		}
		...
		double PowPlant = linear(SimulationData.PowerPlant, time)
				* linear(SimulationData.weather, data.w)
				* data.renewableSolarLevel.get();
		double WindTurbines = linear(SimulationData.WindFarm, time)
				* data.windGenerationLevel.get();
		...
		if (Math.round(BatteryLevel) != data.lastBatteryLevel) {
			...
			MainNetworkHandler.constructAndSendPacket(
					PacketTypes.BATTERY_STORAGE_LEVEL, data.lastBatteryLevel);
		}
